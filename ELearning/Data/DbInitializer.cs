...
//                    }
//                },
//                 new Question{Text = "Dacă dorim să stocăm un șir de elemente fără duplicate într-o colecție fără să ne intereseze ordinea elementelor sau sortarea lor, clasa cea mai potrivită este:", Status = QuestionStatus.Accepted, Difficulty = QuestionDifficulty.Medium, StudentId = 1, AssignmentId = 1, Answers = new List<Answer>(){
//                    new Answer{Text = "HashSet", Correct = true},
//                    new Answer{Text = "HashMap", Correct = false},
//                    new Answer{Text = "TreeMap", Correct = false},
//                    },
//                    QuestionConcepts = new List<QuestionConcept>()
//                    {
//                        new QuestionConcept(){ ConceptId = 1}
//                    }
//                },
//                  new Question{Text = "Vrem să implementăm un framework de user interface. Cu ce design pattern am putea modela comportamentul de onClick → doSomething pentru un element de tip buton oarecare?", Status = QuestionStatus.Accepted, Difficulty = QuestionDifficulty.Medium, StudentId = 1, AssignmentId = 1, Answers = new List<Answer>(){
//                    new Answer{Text = "Observer", Correct = true},
//                    new Answer{Text = "Singleton", Correct = false},
//                    new Answer{Text = "Factory", Correct = false},
//                    },
//                    QuestionConcepts = new List<QuestionConcept>()
//                    {
//                        new QuestionConcept(){ ConceptId = 1}
...
//                new Question{Text = "Ce face comanda grep abc fisier.txt?", Status = QuestionStatus.Accepted, StudentId = 1, AssignmentId = 6, Difficulty = QuestionDifficulty.Hard, Answers = new List<Answer>(){
//                    new Answer{Text = "cauta liniile din fisier care contin textul abc", Correct = true},
//                    new Answer{Text = "cauta liniile din fisier formate din textul abc", Correct = false},
//                    },
//                    QuestionConcepts = new List<QuestionConcept>()
//                    {
//                        new QuestionConcept(){ ConceptId = 6}
//                    }
//                },

//                new Question{Text = "Ce intoarce comanda fork in procesul parinte?", Status = QuestionStatus.Accepted, StudentId = 1, AssignmentId = 6, Difficulty = QuestionDifficulty.Hard,Answers = new List<Answer>(){
//                    new Answer{Text = "pid ul fiului", Correct = true},
//                    new Answer{Text = "0", Correct = false},
//                    },
//                    QuestionConcepts = new List<QuestionConcept>()
//                    {
//                        new QuestionConcept(){ ConceptId = 6}
...
//                 new Question{Text = "Dupa apelul exec intr-un proces acesta:", Status = QuestionStatus.Accepted, StudentId = 1, AssignmentId = 6,Difficulty = QuestionDifficulty.Hard, Answers = new List<Answer>(){
//                    new Answer{Text = "efectueaza comanda si se intoarce la program", Correct = false},
//                    new Answer{Text = "nu face nimic", Correct = false},
//                    new Answer{Text = "efectueaza comanda si abandoneaza programul", Correct = true},
//                    },
//                    QuestionConcepts = new List<QuestionConcept>()
//                    {
//                        new QuestionConcept(){ ConceptId = 6}
...
//                new Question{Text = "Ce este pipe in unix?", Status = QuestionStatus.Accepted, StudentId = 1, AssignmentId = 6, Difficulty = QuestionDifficulty.Hard,Answers = new List<Answer>(){
//                    new Answer{Text = "Canal unidrectional de comunicare intre procese inrudite", Correct = true},
//                    new Answer{Text = "Canal bidirectional de comunicare intre procese inrudite", Correct = false},
//                    new Answer{Text = "Canal bidirectional de comunicare intre oricare 2 procese", Correct = false},
//                    new Answer{Text = "Canal unidirectional de comunicare intre oricare 2 procese", Correct = false},
//                    },
//                    QuestionConcepts = new List<QuestionConcept>()
//                    {
//                        new QuestionConcept(){ ConceptId = 6}
...
//                new Question{Text = "Ce este fifo in unix?", Status = QuestionStatus.Accepted, StudentId = 1, AssignmentId = 6, Difficulty = QuestionDifficulty.Hard,Answers = new List<Answer>(){
//                    new Answer{Text = "Canal unidrectional de comunicare intre procese inrudite", Correct = false},
//                    new Answer{Text = "Canal bidirectional de comunicare intre procese inrudite", Correct = false},
//                    new Answer{Text = "Canal bidirectional de comunicare intre oricare 2 procese", Correct = false},
//                    new Answer{Text = "Canal unidirectional de comunicare intre oricare 2 procese", Correct = true},
//                    },
//                    QuestionConcepts = new List<QuestionConcept>()
//                    {
//                        new QuestionConcept(){ ConceptId = 6}
...
//                new Question{Text = "Ce este testarea de accesibilitate?", Status = QuestionStatus.Accepted, StudentId = 1, AssignmentId = 3, Difficulty = QuestionDifficulty.Easy,Answers = new List<Answer>(){
//                    new Answer{Text = "Verificarea ca un produs este accesibil pentru persoanele cu dizabilitati", Correct = true},
//                    new Answer{Text = "Testarea in urma careia se determina daca produsul va fi acceptat sau nu", Correct = false},
//                    new Answer{Text = "Verificarea ca un produs foloseste metodologiile agile", Correct = false},
//                    },
//                    QuestionConcepts = new List<QuestionConcept>()
//                    {
//                        new QuestionConcept(){ ConceptId = 3}
...
//                 new Question{Text = "Ce este testarea de acceptare?", Status = QuestionStatus.Accepted, StudentId = 1, AssignmentId =3, Difficulty = QuestionDifficulty.Easy,Answers = new List<Answer>(){
//                    new Answer{Text = "Testarea in urma careia se determina daca produsul va fi acceptat sau nu", Correct = true},
//                    new Answer{Text = "Verificarea ca un produs este accesibil pentru persoanele cu dizabilitati", Correct = false},
//                    new Answer{Text = "Verificarea ca un produs foloseste metodologiile agile", Correct = false},
//                    },
//                    QuestionConcepts = new List<QuestionConcept>()
//                    {
...
//                    }
//                },
//                 new Question{Text = "Ce este testarea agile?", Status = QuestionStatus.Accepted, StudentId = 1, AssignmentId = 3, Difficulty = QuestionDifficulty.Easy,Answers = new List<Answer>(){
//                    new Answer{Text = "Testarea in urma careia se determina daca produsul va fi acceptat sau nu", Correct = false},
//                    new Answer{Text = "Verificarea ca un produs este accesibil pentru persoanele cu dizabilitati", Correct = false},
//                    new Answer{Text = "Verificarea ca un produs foloseste metodologiile agile", Correct = true},
//                    },
//                    QuestionConcepts = new List<QuestionConcept>()
//                    {
//                        new QuestionConcept(){ ConceptId = 3}
...
//                 new Question{Text = "Ce este un bug?", Status = QuestionStatus.Accepted, StudentId = 1, AssignmentId = 3, Difficulty = QuestionDifficulty.Easy,Answers = new List<Answer>(){
//                    new Answer{Text = "Verificarea ca un produs foloseste metodologiile agile", Correct = false},
//                    new Answer{Text = "O greseala in program care il face sa se comporte gresit", Correct = true},
//                    new Answer{Text = "Testarea in urma careia se determina daca produsul va fi acceptat sau nu", Correct = false},
//                    },
//                    QuestionConcepts = new List<QuestionConcept>()
//                    {
